...
const Hero = () => {
	return (
		<div className="hero">
			...
			<h2 className="hero__support">I build things for the web.<span> <BsTools /></span></h2>
			<h4 className="hero__description">
				I'm a software engineer specializing in building exceptional digital
				experiences. Currently, I'm focused on building accessible, user
				friendly products.{" "}
			</h4>
      <a className="hero__a" href="https://"><button className="hero__resumeButton">Resume</button></a>
		</div>
	);
};
